...
('SALE500', 500000, '2025-11-05 00:00:00', '2025-12-05 00:00:00', 200, 8000000),
('VIP2025', 2000000, '2025-11-10 00:00:00', '2025-12-31 00:00:00', 30, 20000000),
('FREESHIP', 100000, '2025-11-09 00:00:00', '2025-11-30 00:00:00', 500, 5000000),
...
('Tôi muốn đổi màu xe từ đỏ sang xanh, vui lòng tư vấn quy trình đổi.', 'Yêu cầu đổi xe', 2),
('Cần hóa đơn VAT cho xe Winner X, xin gửi qua email giúp tôi.', 'Hỗ trợ hóa đơn', 3),
('Xe có tiếng kêu bất thường khi chạy tốc độ thấp, cần hỗ trợ kiểm tra.', 'Bảo hành xe', 1),
('Dịch vụ chăm sóc khách hàng rất tốt, cảm ơn cửa hàng.', 'Đánh giá dịch vụ', 4),
('Website lỗi không thể đặt lịch bảo dưỡng, vui lòng kiểm tra.', 'Lỗi website', 2);
